...
public class App extends JFrame {
	...
	// System.out.println("Temps total : " + timeElapsed + "ns");
	// System.out.println("Temps moyen : " + (double) timeElapsed / N_SIGNATURE +
	// "ns");
	//
	// } catch (Exception e) {
	// e.printStackTrace();
	...
	// System.out.println("Temps total : " + timeElapsed + "ns");
	// System.out.println("Temps moyen : " + (double) timeElapsed / N_SYMMETRIC +
	// "ns");
	//
	// } catch (Exception e) {
	// e.printStackTrace();
	...
	// System.out.println("Temps total : " + timeElapsed + "ns");
	// System.out.println("Temps moyen : " + (double) timeElapsed / N_ASYMMETRIC +
	// "ns");
	//
	// } catch (Exception e) {
	// e.printStackTrace();
