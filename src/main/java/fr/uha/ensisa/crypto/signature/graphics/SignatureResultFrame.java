...
public class SignatureResultFrame extends AbstractResultFrame {

	public SignatureResultFrame(Result[] results, long iterations) {
		super("MAC result");
		...
		for (int i = 0; i < results.length; i++) {
			data[i][0] = ((ISignature) results[i].getObject()).name();
